document.addEventListener('DOMContentLoaded', () => {
    ...
    function startPredictionLoop() {
        ...
        predictionInterval = setInterval(() => {
            if (video.videoWidth > 0 && video.videoHeight > 0) {
                ...
                fetch("http://127.0.0.1:5000/predict_frame", {
                    method: 'POST',
                ...
                .then(data => {
                    if (data.prediction) {
                        outputText.textContent = `Prediction: ${data.prediction}`;
        ...
        }, 500); // 2 fps is a good balance for API calls
    }
    ...
    function stopPredictionLoop() {
        ...
        outputText.textContent = "Waiting for clear signs...";
        lastPrediction = "";
    }
