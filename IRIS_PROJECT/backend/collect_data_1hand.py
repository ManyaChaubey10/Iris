...
label = input("Enter LETTER label (A-Z): ")
...
# ✅ Separate dataset
with open("dataset_1hand.csv", "a", newline="") as f:
    writer = csv.writer(f)
    ...
    while True:
        ...
        cv2.imshow("Collect 1-Hand Data", img)
